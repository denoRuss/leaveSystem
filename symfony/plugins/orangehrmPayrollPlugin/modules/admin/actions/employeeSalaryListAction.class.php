...
class employeeSalaryListAction extends viewEmployeeListAction
{
    public function execute($request) {
        ...
        $this->form = new EmployeeSalarySearchForm($this->getFilters());
    ...
    protected function getListConfigurationFactory() {
        ...
        EmployeeSalaryListConfigurationFactory::setLinkSetting($linkSetting);

        $configurationFactory = new EmployeeSalaryListConfigurationFactory();
